...
> mySong = {-Modify (Instrument Applause)-}(Modify(Instrument Gunshot)((c 4 en) :+: d 4 en :+: e 4 en :+: f 4 en :+: (rest 0.15) :+: f 4 en :+: f 4 en :+: (c 4 en) :+: d 4 en :+: (c 4 en) :+: d 4 en :+: (rest 0.1) :+: d 4 en :+: d 4 en)):=: Modify(Instrument Oboe)((c 4 (8)):+:(c 4 (8)):+:(c 4 (8)):+:(c 4 (8)):+:(c 4 (8)):+:(c 4 (8)):+:(c 4 (8)):+:(c 4 (8)))
